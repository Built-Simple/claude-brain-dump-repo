...
const CAROUSEL = {
  ...
  slides: [
    {
      tag: 'The Headline',
      headline: '<em>52%</em> of workers fear AI will displace their job.',
      body: 'Double a year ago.',
      headlineSize: 80,
    },
    {
      tag: 'But Ask Owners',
      headline: 'Ask owners what they actually fear?',
      body: 'Job loss isn\'t in the top three.',
      headlineSize: 80,
    },
    {
      tag: 'Employee Concerns',
      headline: 'Top employee concerns:',
      bullets: [
        'Security (29%)',
        'Incorrect decisions (24%)',
        'Cost (24%)',
        'Job loss: 7%',
      ],
      headlineSize: 80,
    ...
    {
      tag: 'Owner Concerns',
      headline: 'Top owner concerns:',
      bullets: [
        'Looking dumb in front of staff',
        'Being publicly embarrassed by an AI mistake',
        'Spending $5,000 with an agency that can\'t deliver',
      ],
      headlineSize: 72,
    },
    {
      tag: 'The Barrier',
      headline: '<em>49%</em> of SMB owners say "I don\'t know what I don\'t know"',
      body: 'is their #1 barrier.',
      headlineSize: 72,
    },
    {
      tag: 'The Real Objection',
      headline: 'The objection you hear is almost never the objection underneath it.',
      body: '"Too expensive" usually means "I don\'t want to look stupid."',
      headlineSize: 68,
    },
    {
      tag: 'The Approach',
      headline: 'Respect the fear.',
      body: 'Don\'t punch down on the owner who got burned by ChatGPT once. Start with one workflow they trust.',
      headlineSize: 72,
    },
  ],
};
